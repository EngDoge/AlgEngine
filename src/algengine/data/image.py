...
class SingleImage:
    ...
    @property
    @open_file
    def image(self) -> np.ndarray | Image.Image:
        return self._img_data
    ...
    def save(self, dst: str | None = None, force: bool = True, extension: str = '.png') -> None:
    ...
    def show(self,
             ...
             allowed_keys: str | list[str] | None = ' ',
             mark_input: bool = False,
             allowed_marks: str | list[str] | None = None,):
    ...
    @staticmethod
    def get_suffix(file: str) -> str | None:
...
class ImageData:
    __slots__ = ['_cur', '_ref', '_ann', '_mask',
                 '_mov', '_comp', '_id',
    ...
    def get_single_image(self, target_file) -> SingleImage | None:
    ...
    def rename(self, new_name: str, exceptions: list[str] | None = None) -> None:
    ...
    def force_copy_to(self,
                      ...
                      target_attrs: list[str] | str | None = None,
                      exceptions: list[str] | str | None = None) -> None:
    ...
    def __get_attr(self, attr: str) -> Optional['SingleImage'] | str:
        ...
        if memory is None:
            ...
            if not osp.exists(memory):
                ...
                return None
            if self.__use_single_image and attr not in ['ann', 'mov']:
